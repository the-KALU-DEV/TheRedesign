...
//         <p className="text-sm mb-2 bg-green-200 rounded-full w-fit p-2 mb-3">15th February, 2025</p>
...
interface PaystackResponse {
  reference: string;
  // Add other properties from Paystack response if needed.
}
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white px-4">
      ...
      <div className="flex flex-col sm:flex-row w-full max-w-md gap-6 justify-between items-center mt-4">
        ...
        <StyledButton onClick={() => setModalOpen(true)} className="w-fit">
          Continue to pay
        </StyledButton>
      </div>
