...
export default function Payment() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      // Try to retrieve user data from "userInfo" first,
      // then fallback to "otherDetails" if "userInfo" is not found.
      const storedData =
        localStorage.getItem("userInfo") || localStorage.getItem("otherDetails");
